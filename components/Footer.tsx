    ...
    <div className="container mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <a href="mailto:info@amanasia.com" className="text-sm hover:underline block mb-3">info@amanasia.com</a>
          <div className="flex space-x-4">
            <a href="https://www.facebook.com/amanasia" className="text-sm hover:underline">Facebook</a>
            <a href="https://www.twitter.com/amanasia" className="text-sm hover:underline">Twitter</a>
            <a href="https://www.instagram.com/amanasia" className="text-sm hover:underline">Instagram</a>
          </div>
        </div>
        <div>
          <h2 className="font-bold text-lg mb-3">Request a Callback</h2>
          <form>
            <input type="number" placeholder="Enter your phone number" className="w-full px-3 py-2 rounded-lg border-2 border-white focus:outline-none focus:border-blue-500 transition-colors duration-200" />
            ...
            <Button type="submit" className="mt-3 w-full" variant="secondary">Submit</Button>
          </form>
        </div>
      </div>
    </div>
